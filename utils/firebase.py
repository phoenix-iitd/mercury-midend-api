...
def check_firebase_auth():
    try:
        ...
        logging.getLogger("uvicorn.error").info(add_correlation_id("Firebase authentication successful", "firebase_init", logging.INFO))
        return True
    except Exception as e:
        logging.getLogger("uvicorn.error").error(add_correlation_id(f"Firebase authentication failed: {str(e)}", "firebase_init", logging.ERROR))
